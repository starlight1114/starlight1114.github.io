...
This project reads a spreadsheet that contains the names of every LA Metro bus stop in Los Angeles and counts how many of them are on a specific street. Most of the stop names in LA Metro's spreadsheet are written like Street / Cross Street, so I used regular expressions to separate the names and count how many of them are on each street. I also counted the length of the every stop's name in characters and plotted it on a histogram.
...
LA Metro. "GTFS Schedule Data" <https://developer.metro.net/gtfs-schedule-data/>

Repository:

LA Metro. "LA Metro Bus GTFS." October 5, 2025. <https://gitlab.com/LACMTA/gtfs_bus/-/tree/weekly-updated-service>
